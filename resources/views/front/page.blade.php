...
@if ($page->slug == 'contact-us-online-shop')
    ...
    <section style="font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; font-weight: bold ;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <form class="shake" role="form" method="post" id="contactForm" name="contactForm"
                        action="{{ route('contact_us.send') }}">
                        @csrf
                        <div class="mb-3">
                            <label class="mb-2" for="name">Name</label>
                            <input class="form-control" id="name" type="text" name="name"
                                data-error="Please enter your name">
                            <p style="font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; font-weight: bold ;"
                                class="help-block with-errors"></p>
                        </div>
                        ...
                        <div class="form-submit">
                            <button class="btn btn-dark" id="form-submit" type="submit"><i
                                    class="material-icons mdi mdi-message-outline"></i> <i class="fas fa-envelope"
                                    style="margin-right: 10px;"></i> Send Message</button>
