                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div class="d-flex align-items-start">
                                                                                        @php
                                                                                            $productImage = $item->options->productImage; // Access the image from the cart item
                                                                                ...
                                                                                <td>
                                                                                    <div class="input-group quantity mx-auto" style="width: 100px;">
                                                                                        <div class="input-group-btn">
                                                                                            <button class="btn btn-sm btn-dark btn-minus p-2 pt-1 pb-1 sub" data-id="{{ $item->rowId }}" type="button">
                                                                                        ...
                                                                                        <div class="input-group-btn">
                                                                                            <button class="btn btn-sm btn-dark btn-plus p-2 pt-1 pb-1 add" data-id="{{ $item->rowId }}" type="button">
                                                                                ...
                                                                                <td>
                                                                                    <button class="btn btn-sm btn-danger" onclick="deleteItem ('{{ $item -> rowId }}');" title="Remove from cart">
