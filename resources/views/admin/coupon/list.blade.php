                ...
                <table class="table table-hover text-nowrap">
                    <thead>
                        <tr>
                            ...
                            <th width="60" style="text-align: center;">Code</th>
                            <th width="60" style="text-align: center;">Name</th>
                            <th width="60" style="text-align: center;">Discount</th>
                            <th width="60" style="text-align: center;">Start Date</th>
                    ...
                    <tbody>
                        ...
                        @if ($discountCoupons->isNotEmpty())
                            @foreach ($discountCoupons as $discountCoupon)
                                <tr>
                                    <td  width="60" style="text-align: center;">{{ $discountCoupon->id }}</td>
                                    <td  width="60" style="text-align: center;">{{ $discountCoupon->code }}</td>
                                    <td  width="60" style="text-align: center;">{{ $discountCoupon->name }}</td>
                        ...
                        @else
                            <tr  style="text-align: center;">
                                <td colspan="12" style=" font-weight:bolder  font-family:'Times New Roman', Times, serif; color:crimson">Record
                                    Not Found..!</td>
                            </tr>
                        @endif
