...
class AuthController extends Controller
{
    ...
    public function processForgotPassword(Request $request)
    {
        ...
        $formData = [
            'token' => $token,
            'user'  =>  $user,
            'mailSubject'  =>  'You have Received Mail By Reset Password...!'
        ];

        Mail::to($request->email)->send(new ResetPasswordEmail($formData));

        return redirect()->route('front.forgotPassword')->with('success', 'Please check your Inbox to Re-set your Password...!');
    }
